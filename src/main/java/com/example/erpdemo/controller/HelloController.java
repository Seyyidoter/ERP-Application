        ...
        task.setOnSucceeded(ev -> {
            try {
                if (Boolean.TRUE.equals(task.getValue())) {
                    ...
                    st.setTitle("Omnis");
                    st.getIcons().addAll(
                            new Image(getClass().getResourceAsStream("/assets/logo-16.png")),
                            new Image(getClass().getResourceAsStream("/assets/logo-32.png")),
                            new Image(getClass().getResourceAsStream("/assets/logo-64.png"))
                    );
