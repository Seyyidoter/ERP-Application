...
public class RequestController {
    ...
    private void createRequest() {
        try {
            FXMLLoader fxml = new FXMLLoader(getClass().getResource("/fxml/new-request.fxml"));
    ...
    private void deleteSingleRequest() {
        ...
        Async.runVoid(() -> {
                    try { requestService.delete(sel.getId()); }
    ...
    private void refresh() {
        ...
        Async.run(() -> {
                    try {
                        var list = requestService.listSummaries(from, to);
