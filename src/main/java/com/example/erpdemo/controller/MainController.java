...
import com.example.erpdemo.model.ProductDemandStat;
import com.example.erpdemo.model.User;
import com.example.erpdemo.dao.UserDAO;
import com.example.erpdemo.dao.DashboardDAO;
import com.example.erpdemo.util.IconUtil;
import com.example.erpdemo.util.LogoutUtil;
...
public class MainController {
    ...
    @FXML public void goCustomers() { loadContent("/fxml/customer-view.fxml", "Müşteri İşlemleri", "Müşteri İşlemleri"); }
    @FXML public void goRequests()  { loadContent("/fxml/request-view.fxml",  "Talep/Teklif",      "Talep/Teklif"); }
    @FXML public void goProducts()  { loadContent("/fxml/stock-view.fxml",    "Ürün İşlemleri",    "Ürün İşlemleri"); }

    @FXML
    public void goApprovals() {
        if (isAdmin()) loadContent("/fxml/approval-view.fxml", "Onay İşlemleri", "Onay İşlemleri");
        else { loadInlineMessage("Bu alana erişim yetkiniz yok."); selectNav(null); }
    }

    @FXML public void goReports() { loadContent("/fxml/reports-view.fxml", "Raporlar", "Raporlar"); }
